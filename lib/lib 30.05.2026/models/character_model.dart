...
// ✅ دالة للحصول على صورة العرض في المتجر (تظهر الصورة الحقيقية حتى لو مقفلة)
  String getStoreDisplayImage() {
    return imagePath; // دائماً تعرض الصورة الحقيقية
  }

// ✅ دالة للحصول على صورة العرض مع حالة القفل
  String getStoreDisplayImageWithLockState() {
    return imagePath; // نفس الصورة مع إشارة بصرية للقفل في الواجهة
  }
