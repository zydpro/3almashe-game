...
class _SettingsScreenState extends State<SettingsScreen> {
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  // ✅ استخدام الخدمة الجديدة لخيارات الإعلانات (فقط إذا لم تكن الإعلانات معطلة)
  ...
  Widget _buildPaymentStatus(AppLocalizations l10n) {
    return _paymentUIService.buildPaymentStatus(l10n, onRetry: _initializePaymentSystem);
  }

  // ✅ خيار شراء إزالة الإعلانات باستخدام PaymentService
  Widget _buildAdsPurchaseOption(String productId, AppLocalizations l10n) {
    return _paymentUIService.buildAdsRemovalOption(productId, l10n, () => _purchaseAdsRemoval(productId));
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    '${l10n.lastUpdate}: 4 أكتوبر 2025' :
                    '${l10n.lastUpdate}: October 4, 2025',
                    style: const TextStyle(
                      fontSize: 14,
                      color: Colors.white70,
                      fontStyle: FontStyle.italic,
