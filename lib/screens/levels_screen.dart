...
class _LevelsScreenState extends State<LevelsScreen> {
  ...
  Widget _buildPaymentStatus(AppLocalizations l10n) {
    final paymentService = Provider.of<PaymentService>(context, listen: true);
    ...
    } else if (paymentService.errorMessage != null) {
      statusText = paymentService.errorMessage!;
      statusColor = Colors.red;
      statusIcon = Icons.error;
    } else if (!paymentService.isAvailable) {
  ...
  Widget _buildAdsPurchaseOption(String productId, AppLocalizations l10n) {
    final paymentService = Provider.of<PaymentService>(context, listen: true);
    final product = paymentService.getProductById(productId);
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      paymentService.getProductName(productId, l10n.locale.languageCode),
                      style: const TextStyle(
                        fontSize: 14,
                        color: Colors.white,
                    ...
                    const SizedBox(height: 4),
                    Text(
                      paymentService.getProductDescription(productId, l10n.locale.languageCode),
                      style: const TextStyle(
                        fontSize: 11,
                        color: Colors.white70,
                      ),
