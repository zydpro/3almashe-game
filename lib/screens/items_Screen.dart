...
import '../services/payment_service.dart'; // ✅ أضف خدمة الدفع
...
class _itemsScreenState extends State<itemsScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _paymentService = PaymentService(); // ✅ تهيئة خدمة الدفع
    _settingsService.addListener(_onSettingsChanged);
    _paymentService.addListener(_onPaymentUpdate); // ✅ الاستماع لتحديثات الدفع
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // ✅ خيارات شراء العملات من PaymentService
            _buildCoinsPurchaseOption('coins_100', l10n),
            const SizedBox(height: 8),
            _buildCoinsPurchaseOption('coins_500', l10n),
            const SizedBox(height: 8),
            _buildCoinsPurchaseOption('coins_1000', l10n),
            const SizedBox(height: 8),
            _buildCoinsPurchaseOption('coins_5000', l10n),
  ...
  // ✅ بناء خيار شراء العملات
  Widget _buildCoinsPurchaseOption(String productId, AppLocalizations l10n) {
    ...
    return Material(
      ...
      child: InkWell(
        onTap: () => _purchaseCoins(productId),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // خيارات الشراء (فقط إذا لم تكن الإعلانات معطلة)
  ...
  // ✅ بناء خيار شراء إزالة الإعلانات عبر نظام الدفع
  ...
  void dispose() {
    ...
    _paymentService.removeListener(_onPaymentUpdate); // ✅ إزالة المستمع
