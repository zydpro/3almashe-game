...
class _StoreScreenState extends State<StoreScreen> with SingleTickerProviderStateMixin {
  ...
  // ✅ حالة الإعلانات الحالية - تصميم مضغوط
  Widget _buildCompactAdsStatus(AppLocalizations l10n) {
    String statusText;
    Color statusColor;
    IconData statusIcon;
  ...
  // ✅ بناء خيار شراء إزالة الإعلانات
  ...
  // ✅ دوال معالجة الشراء
  void _purchaseCoins(String productId) async {
